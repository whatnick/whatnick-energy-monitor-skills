...
- BOM flow: schematic symbols carry `Manufacturer`, `MPN`, `DigiKey`, `Mouser`, and `Description`; run `scripts/apply_bom_fields.py` then `scripts/export_bom.py` to regenerate grouped CSV/XLSX/HTML purchasing BOM outputs.
